...
bm_status_t bm_memcpy_d2s_poll(bm_handle_t handle, void *dst, bm_device_mem_t src, unsigned int size);
bm_status_t sg_memcpy_d2s_poll(bm_handle_t handle, void *dst, sg_device_mem_t src, unsigned long long size);
bm_status_t bm_memcpy_d2s_poll_u64(bm_handle_t handle, void *dst, bm_device_mem_u64_t src, unsigned long long size);
bm_status_t bm_memcpy_s2d_poll(bm_handle_t handle, bm_device_mem_t dst, void *src);
bm_status_t sg_memcpy_s2d_poll(bm_handle_t handle, sg_device_mem_t dst, void *src);
bm_status_t bm_memcpy_s2d_poll_u64(bm_handle_t handle, bm_device_mem_u64_t dst, void *src);
void *bm_mem_get_system_addr(struct bm_mem_desc mem);
u64 bm_mem_get_size(struct bm_mem_desc mem);
u64 sg_mem_get_size(struct sg_mem_desc mem);
u64 bm_mem_get_size_u64(struct bm_mem_desc_u64 mem);
bm_status_t bm_mem_mmap_device_mem(bm_handle_t handle, bm_device_mem_t *dmem, u64 *vmem);
bm_status_t bm_mem_mmap_device_mem_no_cache(bm_handle_t handle, bm_device_mem_t *dmem, u64 *vmem);
bm_status_t bm_mem_invalidate_partial_device_mem(bm_handle_t handle, bm_device_mem_t *dmem, u32 offset, u32 len);
bm_status_t bm_mem_invalidate_device_mem(bm_handle_t handle, bm_device_mem_t *dmem);
bm_status_t bm_mem_flush_partial_device_mem(bm_handle_t handle, bm_device_mem_t *dmem, u32 offset, u32 len);
