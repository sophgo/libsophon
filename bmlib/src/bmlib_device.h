...
public:
	...
	u64 bm_device_arm_reserved_req(void);
	void bm_device_arm_reserved_rel(void);
	...
	typedef u32 (*t_cmodel_share_reg_func)(void);
...
private:
	...
	bm_status_t bm_alloc_arm_reserved(void);
	void bm_free_arm_reserved(void);
	bm_status_t bm_alloc_instr_reserved(void);
	void bm_free_instr_reserved(void);
	bm_status_t bm_alloc_iommu_reserved(void);
	void bm_free_iommu_reserved(void);
	bm_status_t bm_malloc_device_dword(bm_device_mem_t *pmem, int cnt);
	void bm_free_device(bm_device_mem_t mem);
	bm_status_t bm_init_l2_sram(void);
...
public:
	...
	static bm_device_manager *get_dev_mgr(void);
	static void destroy_dev_mgr(void);

private:
	bm_device_manager(int max_dev_cnt);
	~bm_device_manager(void);
