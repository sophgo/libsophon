...
#pragma pack()
#ifdef __linux__
bm_status_t bmcpu_start_mix_cpu(bm_handle_t handle, char *boot_file, char *core_file);
...
#endif
bm_status_t bm_query_api_data(bm_handle_t handle, sglib_api_id_t api_id, u64 api_handle, u64 *data, int timeout);
#if defined(__cplusplus)
}
#endif
