...
bm_mem_get_device_addr_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：unsigned long long bm_mem_get_device_addr_u64(struct bm_mem_desc_
u64 mem);

函数作用：获取device类型的u64 memory的地址
...
bm_mem_set_device_addr_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：void bm_mem_set_device_addr_u64(struct bm_mem_desc_u64* pmem,
unsigned long long addr);

函数作用：设置一个device类型u64 memory的地址
...
bm_mem_get_device_size_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：unsigned long long bm_mem_get_device_size_u64(struct bm_mem_
desc_u64 mem);

函数作用：获取一块device类型的u64 memory的大小
...
bm_mem_set_device_size_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：void bm_mem_set_device_size_u64(struct bm_mem_desc_u64* pmem,
...
bm_set_device_mem_u64
~~~~~~~~~~~~~~~~~~~~~

函数原型：void bm_set_device_mem_u64(bm_device_mem_u64_t* pmem, unsigned
long long size, unsigned long long addr);
...
bm_mem_from_device_u64
~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_device_mem_u64_t bm_mem_from_device_u64(unsigned long long
 device_addr, unsigned long long len);
...
bm_mem_set_system_addr_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：void bm_mem_set_system_addr_u64(struct bm_mem_desc_u64* pmem,
void \*addr);
...
bm_malloc_neuron_device_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_malloc_neuron_device_u64(bm_handle_t handle, bm_device_mem_u64_t
 \*pmem, unsigned long long n, unsigned long long c, unsigned long long h,
...
bm_malloc_device_dword_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_malloc_device_dword_u64(bm_handle_t handle,
bm_device_mem_u64_t \*pmem, unsigned long long count);
...
bm_malloc_device_byte_u64
~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_malloc_device_byte_u64(bm_handle_t handle,
bm_device_mem_u64_t \*pmem, unsigned long long size);
...
bm_malloc_device_byte_heap_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_malloc_device_byte_heap_u64(bm_handle_t handle,
bm_device_mem_u64_t \*pmem, int heap_id, unsigned long long size);
...
bm_malloc_device_byte_heap_mask_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_malloc_device_byte_heap_mask_u64(bm_handle_t handle,
bm_device_mem_u64_t \*pmem, int heap_id_mask, unsigned long long size);
...
函数原型：bm_status_t bm_malloc_device_mem(bm_handle_t handle, unsigned long long \*paddr,
...
bm_malloc_device_mem_mask
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_malloc_device_mem_mask(bm_handle_t handle,
 unsigned long long \*paddr, int heap_id_mask, unsigned long long size);
...
函数原型：bm_status_t bm_memcpy_s2d_u64(bm_handle_t handle,
...
函数原型：bm_status_t bm_memcpy_s2d_partial_offset_u64(bm_handle_t handle,
 bm_device_mem_u64_t dst, void \*src,
 unsigned long long size,
...
bm_memcpy_s2d_partial_u64
~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_memcpy_s2d_partial_u64(bm_handle_t handle,
 bm_device_mem_u64_t dst, void \*src, unsigned long long size);
...
bm_memcpy_s2d_stride
~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_memcpy_s2d_stride(bm_handle_t handle,
 bm_device_mem_t dst, void *src, struct stride_cfg \*stride);

函数作用：拷贝system内存到device类型内存；效果是从src拷贝stride->width*stride->height长度的有效数据到dst起始地址这个位置上,shape由stride->src_width变为stride->dst_height，高度保持不变，可参考下图：
...
函数原型：bm_status_t bm_memcpy_d2s_u64(bm_handle_t handle, void \*dst,
...
函数原型：bm_status_t bm_memcpy_d2s_partial_offset_u64(bm_handle_t handle,
 void \*dst,
 bm_device_mem_u64_t src, unsigned long long size, unsigned long long offset);
...
| handle       | 输入         | 设备句柄                              |
+--------------+--------------+---------------------------------------+
| dst          | 输入         | 目标system memory的结构体             |
+--------------+--------------+---------------------------------------+
| src          | 输入         | 指向device内存的指针                  |
+--------------+--------------+---------------------------------------+
| stride       | 输入         | stride配置结构体                      |
+--------------+--------------+---------------------------------------+
...
bm_mem_convert_system_to_device_neuron_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_mem_convert_system_to_device_neuron_u64(bm_handle_t handle,
 struct bm_mem_desc_u64 \*dev_mem, struct bm_mem_desc_u64 sys_mem,
...
bm_mem_convert_system_to_device_neuron_byte_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_mem_convert_system_to_device_neuron_byte_u64
(bm_handle_t handle, struct bm_mem_desc_u64 \*dev_mem,
 struct bm_mem_desc_u64 sys_mem, bool need_copy, int n, int c, int h,
 int w);
...
bm_mem_convert_system_to_device_coeff_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_mem_convert_system_to_device_coeff_u64(bm_handle_t handle,
 struct bm_mem_desc_u64 *dev_mem, struct bm_mem_desc_u64 sys_mem,
...
bm_mem_convert_system_to_device_coeff_byte_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_mem_convert_system_to_device_coeff_byte_u64
(bm_handle_t handle, struct bm_mem_desc_u64 *dev_mem,
 struct bm_mem_desc_u64 sys_mem, bool need_copy, int coeff_count);
...
函数原型：bm_memcpy_d2d_u64(bm_handle_t handle, bm_device_mem_u64_t dst,
 unsigned long long dst_offset, bm_device_mem_u64_t src,
...
bm_memcpy_d2d_byte_u64
~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_memcpy_d2d_byte_u64(bm_handle_t handle,
 bm_device_mem_u64_t dst, unsigned long long dst_offset,
 bm_device_mem_u64_t src, unsigned long long src_offset,
 unsigned long long size);
...
bm_memcpy_d2d_stride_u64
~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_memcpy_d2d_stride_u64(bm_handle_t handle,
 bm_device_mem_u64_t dst, unsigned long long dst_stride,
 bm_device_mem_u64_t src, unsigned long long src_stride,
 unsigned long long count, int format_size);
...
bm_memset_device_ext_to_core
~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_memset_device_ext_to_core(bm_handle_t handle, void\*
value, int mode, bm_device_mem_t mem, int core_id);
...
bm_memcpy_c2c_stride
~~~~~~~~~~~~~

函数原型：bm_status_t bm_memcpy_c2c_stride(bm_handle_t src_handle,
 bm_handle_t dst_handle, bm_device_mem_t src, bm_device_mem_t dst,
...
bm_mem_mmap_device_mem_u64
~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_mem_mmap_device_mem_u64(bm_handle_t handle,
 bm_device_mem_u64_t \*dmem, unsigned long long \*vmem);
...
bm_mem_mmap_device_mem_no_cache_u64
~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_mem_mmap_device_mem_no_cache_u64(bm_handle_t handle
, bm_device_mem_u64_t \*dmem, unsigned long long \*vmem);
...
bm_mem_invalidate_device_mem_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_mem_invalidate_device_mem_u64(bm_handle_t handle,
...
bm_mem_invalidate_partial_device_mem_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t sg_mem_invalidate_partial_device_mem(bm_handle_t handle,
 sg_device_mem_t \*dmem, unsigned long long offset, unsigned long long len);
...
bm_mem_flush_device_mem_u64
~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_mem_flush_device_mem_u64(bm_handle_t handle,
bm_device_mem_u64_t \*dmem);
...
bm_mem_flush_partial_device_mem_u64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
bm_mem_unmap_device_mem_u64
~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_mem_unmap_device_mem_u64(bm_handle_t handle, void \*vmem
, unsigned long long size);
...
bm_enable_perf_monitor
~~~~~~~~~~~~~~

函数原型：bm_status_t bm_enable_perf_monitor(bm_handle_t handle,
 bm_perf_monitor_t \*perf_monitor);

函数作用：使能profile monitor
...
| handle       | 输入         | 设备句柄                               |
+--------------+--------------+---------------------------------------+
| perf_monitor | 输出         | 指向一个存放prof perf_monitor数据的结构体|
+--------------+--------------+---------------------------------------+

返回值 ：BM_SUCCESS代表成功；其他错误码代表失败

bm_disable_perf_monitor
~~~~~~~~~~~~~~

函数原型：bm_status_t bm_disable_perf_monitor(bm_handle_t handle,
 bm_perf_monitor_t \*perf_monitor);

函数作用：关闭profile monitor
...
函数原型: bm_status_t bm_get_gmem_heap_id(bm_handle_t handle,
...
| handle       | 输入         | 设备句柄                              |
+--------------+--------------+---------------------------------------+
| tpu_volt     | 输出         | 存储tpu_volt的指针                    |
+--------------+--------------+---------------------------------------+

返回值 ：BM_SUCCESS代表成功；其他错误码代表失败

bm_get_dynfreq_status
~~~~~~~~~~~~~~~
...
| handle       | 输入         | 设备句柄                              |
+--------------+--------------+---------------------------------------+
| dynfreq_status| 输出         | 存储dynfreq_status的指针              |
+--------------+--------------+---------------------------------------+

返回值 ：BM_SUCCESS代表成功；其他错误码代表失败

bm_change_dynfreq_status
~~~~~~~~~~~~~~~
...
| handle       | 输入         | 设备句柄                              |
+--------------+--------------+---------------------------------------+
| bm_api_cfg_pwr_ctrl| 输入         | 设置参数                        |
+--------------+--------------+---------------------------------------+

返回值 ：BM_SUCCESS代表成功；其他错误码代表失败

bm_get_boot_loader_version
~~~~~~~~~~~~~~~

函数原型：bm_status_t bm_get_boot_loader_version(bm_handle_t handle,
 boot_loader_version \*version);

函数作用：获取boot loader版本信息。
...
bmcpu_unload_library
~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bmcpu_unload_library(bm_handle_t handle, int
\process_handle, char \*library_file, int timeout);

函数作用：卸载A53上进程所需要的动态库。
...
bmcpu_exec_function_async
~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bmcpu_exec_function_async(bm_handle_t handle,
 int process_handle, char \*function_name, void \*function_param,
 unsigned int param_size, unsigned long long \*api_handle);
...
bmcpu_exec_function_async_ext
~~~~~~~~~~~~~~~~~~~~~~~

函数原型：bm_status_t bmcpu_exec_function_async_ext(bm_handle_t handle,
 int process_handle, char \*function_name, void \*function_param,
 unsigned int param_size, unsigned int opt, unsigned long long \*api_handle);
...
函数原型：int bmcpu_query_exec_function_result(bm_handle_t handle,
 unsigned long long api_handle, int timeout);

函数作用：查询A53进程执行函数的返回结果。
...
函数原型：bm_status_t bmcpu_set_log(bm_handle_t handle, unsigned int log_level,
 unsigned int log_to_console, int timeout);
...
函数原型：bm_status_t bmcpu_get_log(bm_handle_t handle, int process_handle,
 char \*log_file, int timeout);
...
| handle         | 输入         | 设备句柄                              |
+----------------+--------------+---------------------------------------+
| firmware_tcm   | 输入         | tcm 地址                             |
+----------------+--------------+---------------------------------------+
| firmware_ddr   | 输入         | ddr 地址                              |
+----------------+--------------+---------------------------------------+
