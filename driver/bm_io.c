...
{
	iowrite32(val, bmdi->cinfo.bar_info.io_bar_vaddr.mcu_info_bar_vaddr + reg_offset);
}

u32 mcu_info_reg_read(struct bm_device_info *bmdi, u32 reg_offset)
{
	return ioread32(bmdi->cinfo.bar_info.io_bar_vaddr.mcu_info_bar_vaddr + reg_offset);
}
...
{
	iowrite8(val, bmdi->cinfo.bar_info.io_bar_vaddr.i2c_bar_vaddr + reg_offset + i2c_index*0x2000);
}

u8 i2c_reg_read_byte(struct bm_device_info *bmdi, u8 i2c_index, u32 reg_offset)
{
	return ioread8(bmdi->cinfo.bar_info.io_bar_vaddr.i2c_bar_vaddr + reg_offset + i2c_index*0x2000);
}

void i2c_reg_write(struct bm_device_info *bmdi, u32 i2c_index, u32 reg_offset, u32 val)
{
	iowrite32(val, bmdi->cinfo.bar_info.io_bar_vaddr.i2c_bar_vaddr + reg_offset + i2c_index*0x2000);
}

u32 i2c_reg_read(struct bm_device_info *bmdi, u32 i2c_index, u32 reg_offset)
{
	return ioread32(bmdi->cinfo.bar_info.io_bar_vaddr.i2c_bar_vaddr + reg_offset + i2c_index*0x2000);
}
...
{
	iowrite32(val, bmdi->cinfo.bar_info.io_bar_vaddr.uart_bar_vaddr + uart_index*0x2000 + reg_offset);
}

u32 uart_reg_read(struct bm_device_info *bmdi, u32 uart_index, u32 reg_offset)
{
	return ioread32(bmdi->cinfo.bar_info.io_bar_vaddr.uart_bar_vaddr + uart_index*0x2000 + reg_offset);
}
...
{
	iowrite32(val, bmdi->cinfo.bar_info.io_bar_vaddr.efuse_bar_vaddr + reg_offset);
}
