...
void bm1688_pcie_remap_msi_init(struct pci_dev *pdev, struct bm_device_info *bmdi)
{
	...
	pcie_iatu_addr = bmdi->cinfo.bar_info.bar0_vaddr + BM1688_OFFSET_PCIE_iATU;
...
void bm1688_pcie_msi_irq_enable(struct pci_dev *pdev, struct bm_device_info *bmdi)
{
	...
	//pcie_top_base_addr = bmdi->cinfo.bar_info.bar0_vaddr + BM1688_OFFSET_PCIE_TOP; //0x5fb80000, offeset = 0x380000
