...
typedef enum {
    W5_SET_PARAM_OPT_COMMON       = 0,
    W5_SET_PARAM_OPT_CUSTOM_GOP   = 1,
    W5_SET_PARAM_OPT_CHANGE_PARAM = 0x10,
} W5_SET_PARAM_OPT;
...
#define W5_CMD_DEC_USERDATA_MASK                (W5_REG_BASE + 0x012C)
...
#define W5_CMD_DEC_USERDATA_BASE                (W5_REG_BASE + 0x0170)
#define W5_CMD_DEC_USERDATA_SIZE                (W5_REG_BASE + 0x0174)
#define W5_CMD_DEC_USERDATA_PARAM               (W5_REG_BASE + 0x0178)
...
/************************************************************************/
#define W5_RET_DEC_USERDATA_BASE            (W5_REG_BASE + 0x0114)
#define W5_RET_DEC_USERDATA_SIZE            (W5_REG_BASE + 0x0118)
...
#define W5_ADDR_NAL_SIZE_REPORT_BASE            (W5_REG_BASE + 0x1E0)
...
#define W5_CMD_ENC_SEQ_S2_SEARCH_RANGE          (W5_REG_BASE + 0x1C0)
...
#define W5_CMD_ENC_PIC_S2_SEARCH_CENTER         (W5_REG_BASE + 0x140)
...
#define W5_RET_ENC_NAL_SIZE_REPORT_BASE         (W5_REG_BASE + 0x1A8)
