...
#define P_MBC_PIC_SUB_FRAME_CMD             (MBC_BASE + 0x1f0)          // CODA980, ex) sub frame sync enalbe flag(1bit) : 32'd1 (by sequence)
#define P_MBC_PIC_RUN_IDX                   (MBC_BASE + 0x1f4)          // CODA980, ex) current source buffer index range (3bit valid) : 0, 1, 2 (by frame)
#define P_MBC_SUB_FRAME_SYNC_IF             (MBC_BASE + 0x1f8)          // CODA980, ex)
