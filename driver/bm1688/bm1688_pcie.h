...
#define BM1688_PCIE_EP_SEL_MASK 0x3
#define BM1688_PCIE_EP_SEL_0 BIT(0)
#define BM1688_PCIE_EP_SEL_1 BIT(1)

#define BM1688_PCIE_EP_DBI_0 0x20800000
#define BM1688_PCIE_EP_DBI_1 0x20400000
