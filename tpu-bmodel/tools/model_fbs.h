...
"\n"
"struct RelEntry {\n"
"base_addr_id: uint32;   // index of relocated io addr space\n"
"addr_offset: uint32;    // addr offset from the begening of base_addr.\n"
"cmd_offset: uint32;     // offset (Bytes) in current gdma cmdgroup. (used to reloc cmd)\n"
"}\n"
"\n"
"table CmdGroup {\n"
...
"relentry:RelEntry (id: 13);    // Tensor reloc info in IO_RELOC mode.\n"
"}\n"
"\n"
"table CpuConst {\n"
