...
# Pictures and tables are auto matically numbered
numfig = True
...
latex_elements = {
    ...
    # Set the text font, sans-serif font separately: title, monospaced font: used for transcribing content
    'fontpkg': r'''
    ...
    # Pictures appear strictly in place of text
    # 'figure_align': 'H',
    # preamble style
    # Directory style：tocloft
    # Each section starts on a new page：newcommand{\sectionbreak}{\clearpage}
    # Full text text left aligned：\usepackage[document]{ragged2e}
    'preamble':r'''
    \usepackage{tocloft}
...
latex_documents = [
    (master_doc, project + '.tex', project + u' Technical Reference Manual',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, project, project + u' Technical Reference Manual',
     [author], 1)
]
