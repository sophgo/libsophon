...
void Launcher_SGTPUV8::fill_api_info(const tpu_net_info_t &net_info,
                                     api_info_t &api_info) {
...
bm_status_t Launcher_SGTPUV8::static_subnet(bm_handle_t handle,
...
bm_status_t Launcher_SGTPUV8::dynamic_subnet(
...
bm_status_t Launcher_SGTPUV8::_bmdnn_set_profile_enable_(bm_handle_t handle,
                                                         unsigned int enable) {
  BMRT_ASSERT_INFO(handle, "handle shouldn't be NULL\n");
...
bm_status_t Launcher_SGTPUV8::_bmdnn_get_profile_data_(
