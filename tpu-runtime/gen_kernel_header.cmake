...
# set(KERNEL_MODULE_PATH_CV184X "${PROJECT_SOURCE_DIR}/lib/libcv184x_kernel_module.so")
set(KERNEL_MODULE_PATH_CV184X "${PROJECT_SOURCE_DIR}/../tpu-kernel/lib/$ENV{SDK_VER}/libtpu_kernel_module.so") # KERNEL_MODULE_PATH_CV184X
...
if(LITE_BUILD)
    add_custom_command(
        ...
        COMMAND echo "static const unsigned char kernel_module_data_cv184x[] = {" >> ${KERNEL_HEADER_FILE}
