...
u32 bm1682_cdma_transfer(struct bm_device_info *bmdi, pbm_cdma_arg parg, bool lock_cdma, WDFFILEOBJECT fileObject)
{
    ...
    UNREFERENCED_PARAMETER(lock_cdma);
...
//		if (ret_wait)
//			TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_DEVICE,"End : wait cdma done\n");
//		else {
//			TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_DEVICE,"End : wait cdma timeout!\n");
//			if (lock_cdma)
...
//#endif
//				TraceEvents(TRACE_LEVEL_ERROR, TRACE_DRIVER, "cdma trans over time src %x:%x dst %x:%x\n",
//						src_addr_hi, src_addr_lo, dst_addr_hi, dst_addr_lo);
//				break;
//			}
//		}
//		TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_DEVICE,"cdma transfer using pool mode end\n");
//	}
//	if (lock_cdma)
//		//mutex_unlock(&memcpy_info->cdma_mutex);
	return 0;
