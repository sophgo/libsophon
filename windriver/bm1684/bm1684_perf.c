...
void bm1684_enable_tpu_perf_monitor(struct bm_device_info *bmdi, struct bm_perf_monitor *perf_monitor)
{
	...
	TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_DEVICE,"bm1684 enable  tpu perf monitor size = 0x%x, start addr = 0x%llx, end addr = 0x%llx\n",
...
void bm1684_enable_gdma_perf_monitor(struct bm_device_info *bmdi, struct bm_perf_monitor *perf_monitor)
{
	...
	TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_DEVICE,"bm1684 enable  gdma perf monitor size = 0x%x, start addr = 0x%llx, end addr = 0x%llx\n",
			size, start_addr, end_addr);
