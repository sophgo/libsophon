#ifndef CPU_ADAPTIVE_AVERAGE_POOLING_H
#define CPU_ADAPTIVE_AVERAGE_POOLING_H
 ...
 *  there are no params.
 */ namespace bmcpu {
class cpu_adaptive_average_poolinglayer : public cpu_layer {
public:
    explicit cpu_adaptive_average_poolinglayer() {}
    virtual ~cpu_adaptive_average_poolinglayer() {}
...
#endif /* CPU_ADAPTIVE_AVERAGE_POOLING_H */
