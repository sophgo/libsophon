...
//  BM_API_ID_TANH_FWD_PARALLEL                = 63,
  ...
  BM_API_ID_SORT_PER_DIM                     = 180,
  BM_API_ID_INDEX_SELECT                     = 181,
  BM_API_ID_CONV3D_FWD_PARALLEL              = 182,
  BM_API_ID_MEMCPY_TENSORS                   = 183,
  BM_API_ID_POOLING3D_FWD_FIX8B              = 184,
  BM_API_ID_UPSAMPLE_MASK_FWD                = 185,
  BM_API_ID_YUV_RESIZE                       = 186,
  BM_API_ID_FC_FWD_FIX8B_PARALLEL_OPT        = 187,

  BM_API_ID_REDUCE                           = 200,
  BM_API_ID_SEGMENT_REDUCE                   = 201,
  BM_API_ID_LRN_FIX8B_FWD_PARALLEL           = 202,
  BM_API_ID_UNFOLD                           = 203,
  BM_API_ID_CONV3D_FIX8B_FWD_PARALLEL        = 204,
  ...
  BM_API_ID_CV_SOFT_NMS                      = 511,
  BM_API_ID_CV_SPLIT                         = 512,
  BM_API_ID_CV_TRANSPOSE                     = 513,
  BM_API_ID_CV_FILTER                        = 514,
  BM_API_ID_CV_ADD_WEIGHTED                  = 515,
  BM_API_ID_CV_BATCH_TOPK                    = 516,
  BM_API_ID_CV_YUV2HSV                       = 517,
  BM_API_ID_CV_DCT_COEFF                     = 518,
  BM_API_ID_CV_DCT                           = 519,
  BM_API_ID_CV_CALC_HIST_INDEX               = 520,
  BM_API_ID_CV_FFT_1D                        = 521,
  BM_API_ID_CV_CMULP                         = 522,
  BM_API_ID_CV_DISTANCE                      = 523,
  BM_API_ID_CV_MIN_MAX                       = 524,
  BM_API_ID_CV_ABSDIFF                       = 525,
  BM_API_ID_CV_THRESHOLD                     = 526,
  BM_API_ID_CV_CANNY                         = 527,
  BM_API_ID_CV_MORPH                         = 528,
  BM_API_ID_CV_PYRAMID                       = 529,
  BM_API_ID_CV_LKPYRAMID                     = 530,
  BM_API_ID_CV_LAPLACIAN                     = 531,
  BM_API_ID_CV_AXPY                          = 532,
  BM_API_ID_CV_FUSION                        = 533,
