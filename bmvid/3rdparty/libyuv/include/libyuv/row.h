...
#define HAS_RGBTORGB565ROW_NEON
#define HAS_RGBTOBRG565ROW_NEON
...
#define HAS_I400TORAWROW_NEON
#define HAS_I400TORGB24ROW_NEON
...
#define HAS_I444TORAWROW_NEON
#define HAS_J400TOARGBROW_NEON
#define HAS_J400TORGB24ROW_NEON
...
#define HAS_RAWToJYVURow_NEON
#define HAS_RAWToYUVRow_NEON
...
#define HAS_RGB24ToJYVURow_NEON
#define HAS_RGB24ToYUVRow_NEON
...
#define HAS_RGB24TOUVJ444ROW_NEON
#define HAS_RAWTOUVJ444ROW_NEON
#define HAS_YUY2TOUVROW_NEON
#define HAS_YUY2TOYROW_NEON

#define HAS_YTOYJROW_NEON
#define HAS_UVTOUVJROW_NEON
#define HAS_UVTOUVJROW2_NEON
...
#define FASTROWFUN(rowfun,row_NEON,row_NEONANY,src_buf,dst_buf,height,width,src_stride,dst_stride,scn,dcn) \
    if((height) == 1)                                             \
    {                                                             \
       rowfun((src_buf), (dst_buf), (width));                     \
    }                                                             \
    else                                                          \
    {                                                             \
       int temp = ((width) + (8-1)) & (~(8-1));                   \
       int widthnew = (width);                                    \
       if ((height) > 1 && (src_stride)*2 >= temp*(scn) && (dst_stride)*2 >= temp*(dcn)) \
       {                                                            \
          widthnew = temp;                                          \
          rowfun = row_NEON;                                        \
       }                                                            \
      ...
      for (y = 0; y < (height)-1; ++y) {                            \
        rowfun((src_buf), (dst_buf), widthnew);                     \
        (src_buf) += (src_stride);                                  \
        (dst_buf) += (dst_stride);                                  \
      }                                                             \
                                                                    \
...
void I422ToRGB24Row_NEON(const uint8_t* src_y,
                         ...
                         const struct YuvConstants* yuvconstants,
                         int width);
void I422ToRAWRow_NEON(const uint8_t* src_y,
                       const uint8_t* src_u,
                       const uint8_t* src_v,
                       uint8_t* dst_rgb24,
                       const struct YuvConstants* yuvconstants,
...
void ABGRToYJRow_NEON(const uint8_t* src_abgr, uint8_t* dst_y, int width);
/*
RGB24ToJYVURow_NEON's Matrix
Y = 0.299G+0.587G+0.114B =(38R+75G+15B+64)>>7
Pr = 0.713(R-Y)+128.5  = 183(R-Y)+0x8080 >>8
Pb = 0.564(B-Y)+128.5  = 144(B-Y)+0x8080 >>8
*/
void RGB24ToJYVURow_NEON(const uint8_t* src_bgr24, uint8_t* dst_yuv, int width);
void RAWToJYVURow_NEON(const uint8_t* src_rgb24, uint8_t* dst_yuv, int width);
/*
RGB24ToYUVRow_NEON,PAL yuv's Matrix
Y=0.299G+0.587G+0.114B =(38R+75G+15B+64)>>7
U= 0.436*B-0.289G-0.147R+128 =0.439(B-Y)+128 = 126(B-Y)+0x8080 >>8
V= 0.615R-0.515G-0.1B +128 =0.877(R-Y)+128 = 224(R-Y)+0x8080 >>8
*/
void RGB24ToYUVRow_NEON(const uint8_t* src_bgr24, uint8_t* dst_yuv, int width);
void RAWToYUVRow_NEON(const uint8_t* src_rgb24, uint8_t* dst_yuv, int width);
...
void ARGBToUV444Row_NEON(const uint8_t* src_argb,
                         ...
                         uint8_t* dst_v,
                         int width);
void RGB24ToUVJ444Row_C(const uint8_t* src_rgb24,
                        uint8_t* dst_u,
                        uint8_t* dst_v,
                        int width);
void RGB24ToUVJ444Row_Any_NEON(const uint8_t* src_rgb24,
                               uint8_t* dst_u,
                               uint8_t* dst_v,
                               int width);
void RGB24ToUVJ444Row_NEON(const uint8_t* src_rgb24,
                           uint8_t* dst_u,
                           uint8_t* dst_v,
                           int width);

void RAWToUVJ444Row_C(const uint8_t* src_raw,
                      uint8_t* dst_u,
                      uint8_t* dst_v,
                      int width);
void RAWToUVJ444Row_Any_NEON(const uint8_t* src_raw,
                             uint8_t* dst_u,
                             uint8_t* dst_v,
                             int width);
void RAWToUVJ444Row_NEON(const uint8_t* src_raw,
                         uint8_t* dst_u,
                         uint8_t* dst_v,
                         int width);
...
void ABGRToYJRow_C(const uint8_t* src_argb0, uint8_t* dst_y, int width);
void ABGRToUVJRow_C(const uint8_t* src_argb0, int, uint8_t* dst_u, uint8_t* dst_v, int width);

void RGB24ToYJRow_C(const uint8_t* src_rgb24, uint8_t* dst_y, int width);
/*RAW big endian (rgb in memory) to YPrPb*/
void RAWToJYVURow_C(const uint8_t* src_rgb24, uint8_t* dst_yuv, int width);
/*RGB24 little endian (bgr in memory) to YPrPb*/
void RGB24ToJYVURow_C(const uint8_t* src_rgb24, uint8_t* dst_yuv, int width);
/*RAW big endian (rgb in memory) to PAL YUV*/
void RAWToYUVRow_C(const uint8_t* src_rgb24, uint8_t* dst_yuv, int width);
/*RGB24 little endian (bgr in memory) to PAL YUV*/
void RGB24ToYUVRow_C(const uint8_t* src_rgb24, uint8_t* dst_yuv, int width);
...
void RAWToYJRow_C(const uint8_t* src_argb0, uint8_t* dst_y, int width);
...
void RAWToJYVURow_Any_NEON(const uint8_t* src_rgb24, uint8_t* dst_yuv, int width);
void RGB24ToJYVURow_Any_NEON(const uint8_t* src_bgr24, uint8_t* dst_yuv, int width);
void RAWToYUVRow_Any_NEON(const uint8_t* src_rgb24, uint8_t* dst_yuv, int width);
void RGB24ToYUVRow_Any_NEON(const uint8_t* src_bgr24, uint8_t* dst_yuv, int width);
...
void RGB24ToUVRow_C(const uint8_t* src_rgb,
                    ...
                    uint8_t* dst_v,
                    int width);
void RGB24ToUVJRow_C(const uint8_t* src_rgb0,
                     int src_stride_rgb,
                     uint8_t* dst_u,
                     uint8_t* dst_v,
                     int width);
void RAWToUVRow_C(const uint8_t* src_rgb,
                  ...
                  uint8_t* dst_v,
                  int width);
void RAWToUVJRow_C(const uint8_t* src_rgb0,
                   int src_stride_rgb,
                   uint8_t* dst_u,
                   uint8_t* dst_v,
                   int width);
...
void YToYJRow_C(const uint8_t* src_y,
                uint8_t* dst_yj,
                int width);
void YToYJRow_Any_NEON(const uint8_t* src_y,
                       uint8_t* dst_yj,
                       int width);
void YToYJRow_NEON(const uint8_t* src_y,
                   uint8_t* dst_yj,
                   int width);

void UVToUVJRow_C(const uint8_t* src_uv,
                  uint8_t* dst_uvj,
                  int width);
void UVToUVJRow_Any_NEON(const uint8_t* src_uv,
                         uint8_t* dst_uvj,
                         int width);
void UVToUVJRow_NEON(const uint8_t* src_uv,
                     uint8_t* dst_uvj,
                     int width);

void UVToUVJRow2_C(const uint8_t* src_uv,
                   uint8_t* dst_uj,
                   uint8_t* dst_vj,
                   int width);
void UVToUVJRow2_Any_NEON(const uint8_t* src_uv,
                          uint8_t* dst_uj,
                          uint8_t* dst_vj,
                          int width);
void UVToUVJRow2_NEON(const uint8_t* src_uv,
                      uint8_t* dst_uj,
                      uint8_t* dst_vj,
                      int width);
...
void CopyRow_64_NEON(const uint8_t* src, uint8_t* dst, int width);
...
void ARGBToRGB565Row_NEON(const uint8_t* src_argb,
                          uint8_t* dst_rgb565,
                          int width);
void RGBToRGB565Row_NEON(const uint8_t* src_rgb,
                          uint8_t* dst_rgb565,
                          int width);
void RGBToBGR565Row_NEON(const uint8_t* src_rgb,
                          uint8_t* dst_bgr,
                          int width);
...
void RGBToRGB565Row_C(const uint8_t* src_argb, uint8_t* dst_rgb, int width);
void RGBToBGR565Row_C(const uint8_t* src_rgb, uint8_t* dst_rgb, int width);
...
void I444ToRAWRow_C(const uint8_t* src_y,
                    const uint8_t* src_u,
                    const uint8_t* src_v,
                    uint8_t* dst_raw,
                    const struct YuvConstants* yuvconstants,
                    int width);
void I444ToRAWRow_NEON(const uint8_t* src_y,
                       const uint8_t* src_u,
                       const uint8_t* src_v,
                       uint8_t* dst_raw,
                       const struct YuvConstants* yuvconstants,
                       int width);
void I444ToRAWRow_Any_NEON(const uint8_t* y_buf,
                           const uint8_t* u_buf,
                           const uint8_t* v_buf,
                           uint8_t* dst_ptr,
                           const struct YuvConstants* yuvconstants,
...
void I422ToRGB24Row_C(const uint8_t* src_y,
                      ...
                      const struct YuvConstants* yuvconstants,
                      int width);
void I422ToRAWRow_C(const uint8_t* src_y,
                    const uint8_t* src_u,
                    const uint8_t* src_v,
                    uint8_t* rgb_buf,
                    const struct YuvConstants* yuvconstants,
...
void I400ToRGB24Row_C(const uint8_t* src_y, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width);
void I400ToRGB24Row_NEON(const uint8_t* src_y, uint8_t* dst_rgb24, const struct YuvConstants* yuvconstants, int width);
void I400ToRGB24Row_Any_NEON(const uint8_t* src_ptr, uint8_t* dst_ptr, const struct YuvConstants* yuvconstants,
                             int width);

void J400ToRGB24Row_C(const uint8_t* src_y, uint8_t* dst_rgb24, int width);
void J400ToRGB24Row_NEON(const uint8_t* src_y, uint8_t* dst_rgb24, int width);
void J400ToRGB24Row_Any_NEON(const uint8_t* src_ptr, uint8_t* dst_ptr,
                             int width);

void I400ToRAWRow_C(const uint8_t* src_y, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width);
void I400ToRAWRow_NEON(const uint8_t* src_y, uint8_t* dst_raw, const struct YuvConstants* yuvconstants, int width);
void I400ToRAWRow_Any_NEON(const uint8_t* src_ptr, uint8_t* dst_ptr, const struct YuvConstants* yuvconstants, int width);
...
void ARGBToRGB565Row_Any_NEON(const uint8_t* src_ptr,
                              uint8_t* dst_ptr,
                              int width);
void RGBToRGB565Row_Any_NEON(const uint8_t* src_ptr,
                              uint8_t* dst_ptr,
                              int width);
void RGBToBGR565Row_Any_NEON(const uint8_t* src_ptr,
                              uint8_t* dst_ptr,
                              int width);
...
void I422ToRGB24Row_Any_NEON(const uint8_t* y_buf,
                             ...
                             const struct YuvConstants* yuvconstants,
                             int width);
void I422ToRAWRow_Any_NEON(const uint8_t* y_buf,
                           const uint8_t* u_buf,
                           const uint8_t* v_buf,
                           uint8_t* dst_ptr,
                           const struct YuvConstants* yuvconstants,
