...
void I400ToRGB24Row_NEON(const uint8_t* src_y, uint8_t* dst_rgb24, int width) {
  asm volatile (
    YUVTORGB_SETUP
  "1:                                          \n"
    READYUV400
...
void I400ToRAWRow_NEON(const uint8_t* src_y, uint8_t* dst_raw, int width) {
  asm volatile (
    YUVTORGB_SETUP
  "1:                                          \n"
    READYUV400
...
void RGB24ToYJRow_NEON(const uint8_t* src_rgb24, uint8_t* dst_y, int width) {
  asm volatile(
...
void RAWToYJRow_NEON(const uint8_t* src_raw, uint8_t* dst_y, int width) {
  asm volatile(
      "movi       v4.8b, #15                     \n"  // B * 0.11400 coefficient
      "movi       v5.8b, #75                     \n"  // G * 0.58700 coefficient
      "movi       v6.8b, #38                     \n"  // R * 0.29900 coefficient
...
void RGB24ToJYVURow_NEON(const uint8_t* src_bgr24, uint8_t* dst_yuv, int width) {
  asm volatile(
      "movi       v20.8b, #15                    \n"  // YB * 0.11400 coefficient
      "movi       v21.8b, #75                    \n"  // YG * 0.58700 coefficient
      "movi       v22.8b, #38                    \n"  // YR * 0.29900 coefficient

      "movi       v23.8b, #183                 \n"  // U(R-Y) *  0.713  coefficient
      "movi       v24.8b, #144                    \n"  // U(B-Y) 0.564 coefficient
      ...
      "movi       v3.8h, #64                     \n"  // +0.5
      "umlal      v3.8h, v0.8b, v20.8b           \n"  // +YB
      "umlal      v3.8h, v1.8b, v21.8b           \n"  // +YG
      "umlal      v3.8h, v2.8b, v22.8b           \n"  // +YR
      "sqrshrun   v3.8b, v3.8h, #7               \n"  // 15 bit to 8 bit Y

      "movi       v4.16b, #0x80                  \n"  // +128.5
      "umlal      v4.8h, v2.8b, v23.8b           \n"  // +UR
      "umlsl      v4.8h, v3.8b, v23.8b           \n"  // -UY

      "movi       v5.16b, #0x80                  \n"  // +128.5
      "umlal      v5.8h, v0.8b, v24.8b           \n"  // +UB
      "umlsl      v5.8h, v3.8b, v24.8b           \n"  // -UY

      "uqrshrn    v4.8b, v4.8h, #8               \n"  // 16 bit to 8 bit U
      "uqrshrn    v5.8b, v5.8h, #8               \n"  // 16 bit to 8 bit V

      "st3       {v3.8b,v4.8b,v5.8b}, [%1], #24  \n"  // store 8 pixels Y U V.
      ...
      : "+r"(src_bgr24),  // %0
        ...
        "+r"(width)       // %2
      :
      : "cc", "memory", "v0", "v1", "v2", "v3", "v4", "v5", "v20", "v21", "v22", "v23", "v24");
}
...
void RAWToJYVURow_NEON(const uint8_t* src_rgb24, uint8_t* dst_yuv, int width) {
    asm volatile(
        ...
        "movi       v3.8h, #64                     \n"  // +0.5
        "umlal      v3.8h, v2.8b, v20.8b           \n"  // +YB
        "umlal      v3.8h, v1.8b, v21.8b           \n"  // +YG
        "umlal      v3.8h, v0.8b, v22.8b           \n"  // +YR
        "sqrshrun   v3.8b, v3.8h, #7               \n"  // 15 bit to 8 bit Y

        "movi       v4.16b, #0x80                  \n"  // +128.5
        "umlal      v4.8h, v0.8b, v23.8b           \n"  // +UR
        "umlsl      v4.8h, v3.8b, v23.8b         \n"  // -UY

        "movi       v5.16b, #0x80                  \n"  // +128.5
        "umlal      v5.8h, v2.8b, v24.8b           \n"  // +UB
        "umlsl      v5.8h, v3.8b, v24.8b           \n"  // -UY
...
void RGB24ToYUVRow_NEON(const uint8_t* src_bgr24, uint8_t* dst_yuv, int width) {
  asm volatile(
      ...
      "movi       v23.8b, #126                  \n"  // U(B-Y) *  0.493  coefficient
      "movi       v24.8b, #224                    \n"  // U(R-Y) 0.877 coefficient
...
void RGB24ToUVJ444Row_NEON(const uint8_t* src_rgb24,
  ...
  asm volatile(
      ...
      "umull      v3.8h, v2.8b, v24.8b           \n"  // +VR
      "add        v3.8h, v3.8h, v29.8h           \n"  // +128 -> unsigned
      "umlsl      v3.8h, v1.8b, v27.8b           \n"  // -VG
      "umlsl      v3.8h, v0.8b, v28.8b           \n"  // -VB
...
void RAWToUVJ444Row_NEON(const uint8_t* src_raw,
  ...
  asm volatile(
      ...
      "umull      v4.8h, v2.8b, v24.8b           \n"  // +UB
      "add        v4.8h, v4.8h, v29.8h           \n"  // +128 -> unsigned
      "umlsl      v4.8h, v1.8b, v25.8b           \n"  // -UG
      "umlsl      v4.8h, v0.8b, v26.8b           \n"  // -UR

      "umull      v3.8h, v0.8b, v24.8b           \n"  // +VR
      "add        v3.8h, v3.8h, v29.8h           \n"  // +128 -> unsigned
      "umlsl      v3.8h, v1.8b, v27.8b           \n"  // -VG
      "umlsl      v3.8h, v2.8b, v28.8b           \n"  // -VB
...
/* BT.601 [16,235] ---> BT.601 [0, 255]
 *   yj = (y-16)*255.0/219.0
 */
void YToYJRow_NEON(const uint8_t* src_y, uint8_t* dst_yj, int width) {
  asm volatile(
      " movi    v4.8b, #16                 \n"
      " movi    v5.8b, #42                 \n"
      "1:                                  \n"
      " ld2    {v20.8b, v21.8b}, [%0], #16 \n" /* load 16 Y       */

      " subs    %w2, %w2, #16              \n"

      " uqsub   v20.8b, v20.8b, v4.8b      \n" /* m16=Y-16        */
      " uqsub   v21.8b, v21.8b, v4.8b      \n" /* m16=Y-16        */

      " umull   v22.8h, v20.8b, v5.8b      \n" /* t0=m16*42       */
      " umull   v23.8h, v21.8b, v5.8b      \n" /* t0=m16*42       */

      " uqrshrn v22.8b, v22.8h, #8         \n" /* t0=(t0+128)>>8  */
      " uqrshrn v23.8b, v23.8h, #8         \n" /* t0=(t0+128)>>8  */

      " uqadd   v22.8b, v22.8b, v20.8b     \n" /* m16+t0          */
      " uqadd   v23.8b, v23.8b, v21.8b     \n" /* m16+t0          */

      " st2    {v22.8b, v23.8b}, [%1], #16 \n" /* store 16 YJ     */
      " b.gt 1b                            \n"
      : "+r"(src_y),  // %0
        "+r"(dst_yj), // %1
        "+r"(width)   // %2
      :
      : "cc", "memory", "v4", "v5", "v20", "v21", "v22", "v23");
}

/* BT.601 [16,240] ---> BT.601 [0, 255]
 *   uvj = (uv-128)*255.0/224.0+128
 */
void UVToUVJRow_NEON(const uint8_t* src_uv, uint8_t* dst_uvj, int width) {
  asm volatile(
      " movi   v4.8b, #128                 \n"
      " movi   v5.8b, #35                  \n"
      "1:                                  \n"
      ...
      " sub     v22.8b, v20.8b, v4.8b      \n" /* t0=C-128       */
      " sub     v23.8b, v21.8b, v4.8b      \n" /* t0=C-128       */

      " smull   v22.8h, v22.8b, v5.8b      \n" /* t0=t0*35       */
      " smull   v23.8h, v23.8b, v5.8b      \n" /* t0=t0*35       */

      " sqrshrn v22.8b, v22.8h, #8         \n" /* t0=(t0+128)>>8 */
      " sqrshrn v23.8b, v23.8h, #8         \n" /* t0=(t0+128)>>8 */

      " usqadd  v20.8b, v22.8b             \n" /* C+t0           */
      " usqadd  v21.8b, v23.8b             \n" /* C+t0           */

      " st2    {v20.8b, v21.8b}, [%1], #16 \n" /* store 16 UJ/VJ  */
      " b.gt 1b                            \n"
      : "+r"(src_uv),  // %0
        "+r"(dst_uvj), // %1
        "+r"(width)    // %2
...
void UVToUVJRow2_NEON(const uint8_t* src_uv, uint8_t* dst_uj,
                      uint8_t* dst_vj, int width) {
  asm volatile(
      " movi   v4.8b, #128                 \n"
      " movi   v5.8b, #35                  \n"
      "1:                                  \n"
