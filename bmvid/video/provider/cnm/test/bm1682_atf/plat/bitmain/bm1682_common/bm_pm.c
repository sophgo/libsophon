 ...
 ******************************************************************************/
static int bm_validate_power_state(unsigned int power_state,
...
{
    ERROR("BM System Off: operation not handled.\n");
    panic();
}

static void __dead2 bm_system_reset(void)
{
    ERROR("BM System Reset: operation not handled.\n");
    panic();
}

static const plat_psci_ops_t plat_bm_psci_pm_ops = {
