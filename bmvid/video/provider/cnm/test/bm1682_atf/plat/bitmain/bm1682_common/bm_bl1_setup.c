...
void bl1_early_platform_setup(void)
{
    ...
    *(unsigned int *)0x500081C0 = 0; // TODO: disable interleave for now
    /*
     * u-boot needs valid cntfrq value for timer.
     * for kenrel's needs, check clock-frequency section in
     * Documentation/devicetree/bindings/arm/arch_timer.txt.
     */
    write_cntfrq_el0(SYS_COUNTER_FREQ_IN_TICKS);
