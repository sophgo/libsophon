...
#define INIT_DATA_A (uint64_t)0x67452301L
#define INIT_DATA_B (uint64_t)0xefcdab89L
#define INIT_DATA_C (uint64_t)0x98badcfeL
#define INIT_DATA_D (uint64_t)0x10325476L
