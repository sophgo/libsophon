...
DECL_EXPORT tpu_kernel_module_t tpu_kernel_load_module_file(bm_handle_t handle, const char *module_file);
DECL_EXPORT tpu_kernel_module_t tpu_kernel_load_module_file_key(bm_handle_t handle, const char *module_file, const char *key, int size);
DECL_EXPORT bm_status_t tpu_kernel_unload_module_file(bm_handle_t handle, tpu_kernel_module_t p_module);
DECL_EXPORT tpu_kernel_module_t tpu_kernel_load_module(bm_handle_t handle, const char *data, size_t length);
DECL_EXPORT tpu_kernel_function_t tpu_kernel_get_function(bm_handle_t handle, tpu_kernel_module_t module, const char *function);
DECL_EXPORT bm_status_t tpu_kernel_launch(bm_handle_t handle, tpu_kernel_function_t function, void *args, size_t size);
