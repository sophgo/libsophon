...
if(NOT DEFINED ARM_LINUX_SYSROOT AND DEFINED GNU_MACHINE)
  execute_process(COMMAND ${CMAKE_CXX_COMPILER} -print-sysroot OUTPUT_VARIABLE ARM_LINUX_SYSROOT OUTPUT_STRIP_TRAILING_WHITESPACE)
endif()
...
if(NOT DEFINED CMAKE_CXX_FLAGS)
  ...
  if(CMAKE_SYSTEM_PROCESSOR STREQUAL aarch64)
    set(CMAKE_CXX_FLAGS           "-march=armv8-a -mtune=cortex-a53 ${CMAKE_CXX_FLAGS}")
    set(CMAKE_C_FLAGS             "-march=armv8-a -mtune=cortex-a53 ${CMAKE_C_FLAGS}")
    #set( CMAKE_CXX_FLAGS_RELEASE   " -DNDEBUG  ${CMAKE_CXX_FLAGS_RELEASE}")
    #set( CMAKE_C_FLAGS_RELEASE     " -DNDEBUG  ${CMAKE_C_FLAGS_RELEASE}" )
    set( CMAKE_CXX_FLAGS_DEBUG     "-O0 -g -DDEBUG -D_DEBUG ${CMAKE_CXX_FLAGS_DEBUG}")
    set( CMAKE_C_FLAGS_DEBUG       "-O0 -g -DDEBUG -D_DEBUG ${CMAKE_C_FLAGS_DEBUG}")
  endif()
  if(DEFINED CMAKE_FFMPEG_LINK_PATH)
    foreach(m ${CMAKE_FFMPEG_LINK_PATH})
      set(CMAKE_CXX_FLAGS           "${CMAKE_CXX_FLAGS} -Wl,-rpath-link=${m}")
      set(CMAKE_C_FLAGS             "${CMAKE_C_FLAGS} -Wl,-rpath-link=${m}")
      set(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} -Wl,-rpath-link=${m}")
    endforeach()
  endif()
  if(CMAKE_SYSTEM_PROCESSOR STREQUAL arm)
