...
function vpp_border()
{
    ./vpp_border 1920 1080 bgr-org-opencv-bmp3.bin 32 32 32 32 out.bmp
    ...
    if [ "$result" -ne 0 ]; then
        echo "vpp_border -- error" >> result.txt
    else
        echo "vpp_border -- okay" >> result.txt
    fi
...
{
    ./vpp_convert 1920 1080 bgr-org-opencv.bin 3 1 i420.yuv
    ./vpp_convert 1920 1080 rgbp.bin 5 1 i420.bin
    ./vpp_convert 1920 1080 img1.nv12 2 6 bgrp3.bin
    ./vpp_convert 1920 1080 img2.yuv 1 3 out.bmp
    ./vpp_convert 1920 1080 bgr-org-opencv.bin 3 7 yuv444p
    ./vpp_convert 1920 1080 yuv444p.bin  7 8 yuv422p.bin 
    ./vpp_convert 1920 1080 yuv444packed 9 3 bgr5.bmp
...
{
    ./vpp_cropsingle 1920 1080 bgr-org-opencv-bmp3.bin 3 crop
...
function vpp_resize()
{
    ./vpp_resize 1920 1080 img2.yuv 1 954 488 i420.yuv
    ./vpp_resize 1920 1080 bgr-org-opencv.bin  3 877 1011 bgr2.bmp
    ./vpp_resize 1920 1080 bgrp.bin 6 1386 674 bgrp2.bin
    ./vpp_resize 1920 1080 yuv444p.bin 7  2731 1673 yuv.444p
...
echo "vpp_split"
./vpp_split 1920 1080 bgr-org-opencv.bin r.bmp g.bmp b.bmp
